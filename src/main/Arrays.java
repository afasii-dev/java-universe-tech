...
//        1) Массив - это переменная, в которую можно положить сразу несколько значений.
...
//        boolArray[11] = true; - Index out of bounds
